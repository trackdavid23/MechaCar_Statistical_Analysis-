...
library(tidyverse)
MechaCar_mpg <- read.csv(file='/Users/bigd/Downloads/MechaCar_mpg.csv',check.names=F,stringsAsFactors = F) 
...
Suspension_Coil <- read.csv(file='/Users/bigd/Downloads/Suspension_Coil.csv' ,check.names=F,stringsAsFactors = F) 
